...
app.get('/polls', (req, res) =>
{
		...
		{
         console.log(data);
         queryMysql(`select * from preguntas`, (error, opciones) => 
         {
...
app.put('/updatePoll', (req, res) =>
{
	...
	muestraEncuesta(token, (err,data) =>
		{
         console.log(data);
         queryMysql(`select * from preguntas where id_pregunta = '${data.id_pregunta}' and total<= 0`, (error, opciones) => 
	     {
	...
	muestraEncuesta(token, (err,data) =>
		{
         ...
         queryMysql(`update preguntas set total= '0' where id = '${data.id}'`, (error, opciones) => 
		      {	console.log(data);
				console.log(opciones);
		     	res.json({{data}});
		     });
