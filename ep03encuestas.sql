...
-- Volcando datos para la tabla ep03encuestas.preguntas: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla ep03encuestas.respuestas: ~8 rows (aproximadamente)
